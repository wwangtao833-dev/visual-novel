...
当前收录 **88 部代表作品、171 个平台版本**，覆盖 1980—2025 年，重点补充了 1980—1985 年的欧美文字／图文冒险、日本 PC 冒险与激光影碟互动动画。此项目不是完整历史清单；早期作品缺乏可靠版本信息的地方保持“待核实”。首发年份取所收录的最早版本；平台移植与重制按所引来源的发行地区记录，尚未逐一列出所有地区的发售时间。早期作品的日期异文与收录原则见 [`data/early-era-notes.md`](data/early-era-notes.md)。
